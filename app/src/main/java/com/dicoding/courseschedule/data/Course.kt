...
data class Course(
    ...
    @ColumnInfo(name = COL_COURSE_NAME) val courseName: String,
    @ColumnInfo(name = COL_DAY) val day: Int,
    @ColumnInfo(name = COL_START_TIME) val startTime: String,
    @ColumnInfo(name = COL_END_TIME) val endTime: String,
    @ColumnInfo(name = COL_LECTURER) val lecturer: String,
